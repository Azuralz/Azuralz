...
//	MYI2C_Stop();
	...
	I2C_Send7bitAddress(I2C2, MPUAddress, I2C_Direction_Transmitter);
...
//	MYI2C_Stop();
	...
	I2C_Send7bitAddress(I2C2, MPUAddress, I2C_Direction_Receiver);
...
//	MYI2C_Init();
	...
	I2C_InitStructre.I2C_Ack = I2C_Ack_Enable;
	I2C_InitStructre.I2C_AcknowledgedAddress = I2C_AcknowledgedAddress_7bit;
	I2C_InitStructre.I2C_ClockSpeed = 50000;//通讯速度
	I2C_InitStructre.I2C_DutyCycle = I2C_DutyCycle_2;//占空比高低电平比例
	I2C_InitStructre.I2C_Mode = I2C_Mode_I2C;//模式选择
	I2C_InitStructre.I2C_OwnAddress1 = 	0X00;
	I2C_Init(I2C2, &I2C_InitStructre);
